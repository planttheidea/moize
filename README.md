...
**NOTE**: This documentation is for the next major version of `moize`, please go to the [`v5` branch](https://github.com/planttheidea/moize/tree/v5) to see documentation on the current major version.
